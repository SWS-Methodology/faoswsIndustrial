...
1. to pull the vegetables oils data by country and year provided by the United States Department of Agriculture and stored in **usda/usda_psd**.
...
2. to pull the biofuels data by country and year provided by the United States Department of Agriculture and stored in **industrialUse/biofuel**.
...
3. to merge both datasets and calculate the quantity of industrial utilization. This dataset was saved in domain = "agriculture", dataset = "aproduction", data = industrialUsesData.
