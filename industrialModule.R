...
tab1991to1994 <- europeanCountry1990[geographicUsda %in% unique(memberStatesEU[accession %in% c("before1990")][, usda_code])]
...
tab1995to2003 <- europeanCountry1990[geographicUsda %in% unique(memberStatesEU[accession %in% c("before1990", "1995")][, usda_code])]
...
tab2004to2006 <- europeanCountry1990[geographicUsda %in% unique(memberStatesEU[accession %in% c("before1990", "1995", "2004")][, usda_code])]
...
tab2007to2012 <- europeanCountry1990[geographicUsda %in% unique(memberStatesEU[accession %in% c("before1990", "1995", "2004", "2007")][, usda_code])]
...
tab2013to2015 <- europeanCountry1990[geographicUsda %in% unique(memberStatesEU[accession %in% c("before1990", "1995", "2004", "2007", "2013")][, usda_code])]
